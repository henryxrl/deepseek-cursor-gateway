...
from .image_handler import sanitize_image_payload_for_trace
    ...
    for index, message in enumerate(messages):
        ...
        summary: dict[str, Any] = {
            ...
            "has_recovery_notice": content.startswith(
                (
                    "[deepseek-cursor-gateway] Refreshed reasoning_content history.",
                    "[deepseek-cursor-gateway] Recovered",
                )
            ),
        }
...
class TraceRequest:
    ...
    def record_cursor_body(self, payload: dict[str, Any]) -> None:
        ...
        self.data["request"]["body"] = sanitized
        self.data["request"]["summary"] = payload_summary(sanitized)
    ...
    def record_transform(self, prepared: Any) -> None:
        self.data["transform"] = {
            ...
            "upstream_request_body": sanitize_image_payload_for_trace(prepared.payload),
        }
